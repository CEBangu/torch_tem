...
date = '2025-01-03' # 2020-10-13 run 0 for successful node agent
run = '0'
index = '18000'

# Load the model: use import library to import module from specified path
model_spec = importlib.util.spec_from_file_location("model", '/Users/ciprianbangu/Cogmaster/S3/Robotics/presentation/Summaries/' + date + '/run' + run + '/script/model.py')
model = importlib.util.module_from_spec(model_spec)
model_spec.loader.exec_module(model)

# Load the parameters of the model
params = torch.load('/Users/ciprianbangu/Cogmaster/S3/Robotics/presentation/Summaries/' + date + '/run' + run + '/model/params_' + index + '.pt')
# Create a new tem model with the loaded parameters
tem = model.Model(params)
# Load the model weights after training
model_weights = torch.load('/Users/ciprianbangu/Cogmaster/S3/Robotics/presentation/Summaries/' + date + '/run' + run + '/model/tem_' + index + '.pt')
...
envs = list(glob.iglob('/Users/ciprianbangu/Cogmaster/S3/Robotics/presentation/Summaries/' + date + '/run' + run + '/script/envs/*'))
